...
6. 措辞不同不代表不匹配，常见同义对应要敢映射：
   出生地/成长地/祖籍 → 籍贯；户口所在地/户籍 → 户籍所在地；生源地 → 生源地；
   毕业时间 → 教育经历的结束时间；
...
# 常见站点措辞 → 扁平档案标签：唯一事实源在 core.profile.catalog
# （与 FLAT_LABELS/RESTRICTED_LABELS 同处维护，守护测试防目标漂移）。
from autooffer_core.profile.catalog import LABEL_ALIASES as _LABEL_ALIASES  # noqa: E402
